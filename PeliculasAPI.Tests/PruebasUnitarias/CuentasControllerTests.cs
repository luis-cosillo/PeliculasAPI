...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class CuentasControllerTests: BasePruebas
    {
            ...
            IAuthenticationSchemeProvider schemeProvider = null) where TUser : class
        {
            ...
            var sm = new SignInManager<TUser>(manager, contextAccessor.Object, claimsFactory, 
                options.Object, null, schemeProvider, new DefaultUserConfirmation<TUser>());
        ...
        private CuentasController ConstruirCuentasController(string nombreBD)
        {
            ...
            return new CuentasController(userManager, configuration, signInManager,  context, mapper);
        }
        ...
        private async Task CrearUsuarioHelper(string nombreBD)
        {
            ...
            var userInfo = new UserInfo() { Email = "ejemplo@hotmail.com", Password = "Abc123*" };
